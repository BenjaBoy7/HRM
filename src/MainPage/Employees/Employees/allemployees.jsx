          ...
          <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
            <div className="profile-widget">
              <div className="profile-img">
                <a href="/app/profile/employee-profile" className="avatar" src><img src={baseUrl+"images/employees/photo/"+employee.photo} alt="" /></a>
              </div>
              ...
              <div className="small text-muted">{employee.contact}</div>
            </div>
          </div>
        ))}
